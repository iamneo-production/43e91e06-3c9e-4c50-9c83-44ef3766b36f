...
import com.examly.springapp.Service.CustomUserService;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.authorizeRequests((request)->request.antMatchers("h2-console/**","/api/v1/auth/login","api/v1/auth/dashbord",",/api/v1/auth/userinfo","/users/addUser","/users/addAuthority","/users/addAuth","/users/viewusers").permitAll().antMatchers(HttpMethod.OPTIONS,"/**").permitAll().anyRequest().authenticated())
